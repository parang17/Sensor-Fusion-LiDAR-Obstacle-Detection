...
void CityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI> pointProcessor, pcl::PointCloud<pcl::PointXYZI>::Ptr inputCloud)
{
    ...
    // Solving RANSAC problem to identify the ground and non-ground objects
    //PCL method
//    std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr, pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = pointProcessor.SegmentPlanePCL(inputCloud, 25, 0.3);
    //My solution
    ...
    //PCL method
//    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor.ClusteringPCL(segmentCloud.first, 0.53, 10, 500);
    //My solution
